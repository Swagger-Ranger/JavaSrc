...
/**
 * A from-first-principles implementation of a simple map dictionary structure.
 * Based on HashMap, but with material removed.
 * 
 * @author ben
 */
public class SimpleDict implements Map<String, String> {
    private final Node[] table; // Hash buckets (head of linked lists)
    private int size; // entries in the dict
